    ...
    var interval = setInterval(function() {
        ...
        if(seconds == 0) {
            if(minute_text == '' && hour_text == '') {
                ...
                if(['countdown4', 'countdown5', 'countdown6', 'countdown7', 'countdown8', 'countdown9', 'countdown10',
                    'countdown11', 'countdown12', 'countdown13', 'countdown14', 'countdown15'].includes(element)){
                ...
                let priority1 = ['countdown1', 'countdown2', 'countdown3', 'countdown4', 'countdown5',
                                 ...
                                 'countdown11', 'countdown12', 'countdown13', 'countdown14', 'countdown15', 
                                 'countdown29', 'countdown30', 'countdown31'];
                                 
                let priority2 = [990,991,992];
                let priority3 = [16, 17];
                let priority4 = [18, 19, 20, 21];
